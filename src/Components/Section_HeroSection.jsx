...
export default function HeroSection() {
  ...
  return (
    <div className="section-hero-section">
                    <video muted autoPlay id="vid"className="videoHero" width="820" height="540" > <source src="https://raw.githubusercontent.com/mikelandy86/website2.0/main/src/assets/public/images/HeroLogo.mp4"   type="video/mp4"></source></video>
