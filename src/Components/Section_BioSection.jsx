  ...
  return (
    <div id="bio" className="section-bio">
      <div className="section-bio-title">
        <h1>
          <FaUserAlt size={35} /> Om <h1>Mig</h1>
        </h1>
      </div>
            ...
            <Fade cascade triggerOnce="true" duration="500" direction="up">
              ...
              <div id="blockB" className="section-bio-infodesc">
                <p>
                  ...
                  den kreativa processen att förena logik och grafik vilket även
                  lett mig in i frontend-utveckling med React och Javascript.
                  Har haft möjligheten att arbeta med intressanta projekt med
                  hjälp av innovativa teknologier som VR och AR, och brinner för
                  nya lösningar och uppfinningsrika sätt att driva samhället
                  framåt med ett team av motiverade kollegor.
                </p>
              </div>
            </Fade>
          </div>
